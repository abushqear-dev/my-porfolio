...
import { personalInfo, experience } from "@/app/data";
  ...
  return (
    <aside className="space-y-10 lg:sticky lg:top-10 lg:self-start">
      ...
      <nav className="flex flex-wrap gap-4 text-xs uppercase tracking-[0.32em] text-muted">
        <Link href="/#projects" className="transition hover:text-heading">
          Projects
        </Link>
        {experienceItems.length > 0 && (
          <Link href="/#experience" className="transition hover:text-heading">
            Experience
          </Link>
        )}
